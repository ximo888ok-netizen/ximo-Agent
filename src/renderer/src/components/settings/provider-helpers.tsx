...
export const inputCls = 'w-full rounded-card border border-border bg-bg-elevated px-3 py-2 text-sm text-text-primary placeholder:text-text-muted focus:border-accent focus-ring'
...
export function CapToggle({ label, desc, value, onChange }: {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-between rounded-card border border-border-subtle bg-bg-elevated px-3 py-2 text-left transition-colors hover:border-border-hover active:scale-[0.97]"
    >
